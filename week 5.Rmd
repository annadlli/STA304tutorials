...
output: pdf_document
---
Git repository code https://github.com/annadlli/STA304tutorials.git
...
The question that we would like to address here is this: 200 years after Gauss, can we do better? What can be done to improve our ability to reproduce computational results in econometrics and related fields? Our main contention is that recent software developments, notably in the opensource community, make it much easier to achieve and distribute reproducible research. 
